import { dumpDataType, getAll, getItem, getPropertyArray, getPropertyArrayFromItemArray, getPropertyArrayFromItemArrayUnique, init, instanceNewItem, itemByKey, putTablesIntoSchemaItems, save, setItem, storeData, instanceItem, getStoreTypeByName } from ".";
import { storedItem } from "./storedItem";
import { messageLevels } from "./types";
import { storeType } from "./storeType";

export class context extends storedItem {
    ...
    getStoreTypeByName(name: string, createMissing?: boolean): storeType | null {
        return getStoreTypeByName(name, createMissing);
    }
}
