import { dumpDataType, getAll, getItem, getPropertyArray, getPropertyArrayFromItemArray, getPropertyArrayFromItemArrayUnique, init, instanceNewItem, itemByKey, putTablesIntoSchemaItems, save, setItem, storeData } from "..";
import { storedItem } from "../storedItem";
import { messageLevels } from "../types";

export class editContext extends storedItem {
